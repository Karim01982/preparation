...
Besides the commentary above on robustness, we recognise there are several issues within our data. The original sample, though randomly generated, does not facilitate a more comprehensive assessment of Hollywood and non-Hollywood film statistics over the time horizon. Being unable to source separate details on financial characteristics on each film, has hindered this process, whilst limiting our ability to investigate the full value chain. Examples of other characteristics that we would like to have appraised includes:

* A breakdown of budget expenses: understanding the level of marketing spend to promote films prior to release, along with the breakdown of total pre and post production costs, including actor salaries for the leading actor(s) / supporting actors
