...
rev_mod9 <- lm(data=data11_15, log6_gross ~ budget + actiondummy + scifidummy +  director_occurence + num_voted_users)

log6_gross <- (log(data16$gross)^6)

rev_mod10 <- lm(data=data16, log6_gross ~ budget + actiondummy + scifidummy + director_occurence + num_voted_users)
