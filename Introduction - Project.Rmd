...
Although continued growth in Chinese and Indian box office revenues is likely to dominate the period to 2020, Hollywood is likely to remain a bellweather of judging a film's global success, given its wide audience base. With that in mind, are there factors that can help predict a Hollywood film's popularity, and with that, guide future decisions on the types of films produced? In turn, can this better inform investors on potential risks involved with backing particular projects?
