...
There are several intriguing observations. Firstly we observe that all our variables except IMDB scores are positively skewed, with the latter negatively skewed. This confounds our earlier thoughts on IMDB scores being normally distributed. With a median score of 6.7, this implies fans are likely to respond with favourable views, especially with our 1st and 3rd quartile scores between 6.1 and 7.2 respectively. Mopre generally, we will need to proceed with any regression analysis carefully (see further comments below).
...
The final criteria we consider is film genre. This is not straightforward, as a film can belong to more than one category (e.g. an action thriller)
