...
We first examine the impact of particular actors and director (equations 2 and 3). This counts the number of occurrences within our sample, and is limited in not consider other films within the period. Notwithstanding, this may help reduce any serial correlation within our error term (i.e. an actor favoured in the past is likely to remain favoured at present). From our results, only the 1st actor appears statistically significant, with a negligible impact on increasing our adjusted ${R}^{2}$. 
