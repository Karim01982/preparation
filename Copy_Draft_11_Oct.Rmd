...
rev_mod10 <- lm(data=data11_15, gross ~ (budget + actiondummy + director_occurence))
rev_mod11 <- lm(data=data11_15, gross ~ (budget + actiondummy + actor1_occurence + actor2_occurence + num_voted_users))
rev_mod12 <- lm(data=data11_15, log6_gross ~ (budget + actiondummy + actor1_occurence + actor2_occurence + num_voted_users))
...
#residualPlot(rev_mod6)
#residualPlot(rev_mod6_log)
>>>>>>> db756c2053ba305872d78953b3933728b8a75cdf
