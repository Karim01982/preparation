...
rev_mod2 <- lm(data=data11_15, gross ~ (budget + actiondummy + scifidummy + comedydummy))
...
rev_mod5 <- lm(data=data11_15, gross ~ (budget + actiondummy + scifidummy + actor1_occurence))
rev_mod6 <- lm(data=data11_15, gross ~ (budget + actiondummy + scifidummy + actor2_occurence))
rev_mod7 <- lm(data=data11_15, gross ~ (budget + actiondummy + scifidummy + actor3_occurence))
rev_mod8 <- lm(data=data11_15, gross ~ (budget + actiondummy + scifidummy + director_occurence))
rev_mod9 <- lm(data=data11_15, gross ~ (budget + actiondummy + director_occurence + actor1_occurence + actor2_occurence + actor3_occurence))
rev_mod10 <- lm(data=data11_15, gross ~ (budget + actiondummy + actor1_occurence + actor2_occurence + num_voted_users))
rev_mod11 <- lm(data=data11_15, log6_gross ~ (budget + actiondummy + actor1_occurence + actor2_occurence + num_voted_users))

stargazer(rev_mod1, rev_mod2, rev_mod3, rev_mod4, rev_mod5, rev_mod6, rev_mod7, rev_mod8, rev_mod9, rev_mod10, rev_mod11, type = "html", report = "vct*")
...
residualPlot(rev_mod6)
residualPlot(rev_mod6_log)
