...
CrossTable( x = test_labels, y = predict10, prop.chisp = FALSE)
mean(test_labels == predict10)

predict40 <- knn(train = traind, test = testd, cl = train_labels, k =10)
CrossTable( x = test_labels, y = predict40, prop.chisp = FALSE)
mean(test_labels == predict40)
